      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full px-4">
        {currentProducts.map((product) => {
          ...
          return (
            <div
              key={product.id}
              className="w-full bg-white shadow-lg rounded-2xl overflow-hidden transition-all hover:scale-[1.02] hover:shadow-xl border border-gray-200 mx-auto max-w-xs">
